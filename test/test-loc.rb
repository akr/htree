...
class TestLoc < Test::Unit::TestCase
  def test_make_loc
    ...
    assert_instance_of(HTree::Elem::Loc, t.root.make_loc)
    assert_instance_of(HTree::Text::Loc, t.root.children[0].make_loc)
    assert_instance_of(HTree::ProcIns::Loc, t.root.children[1].make_loc)
    assert_instance_of(HTree::Comment::Loc, t.root.children[2].make_loc)
    assert_instance_of(HTree::BogusETag::Loc, t.root.children[3].make_loc)
